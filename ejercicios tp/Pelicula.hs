...
peliculas  = [pelicula9 , pelicula6, pelicula3, pelicula4, pelicula5, pelicula2, pelicula7, pelicula8,pelicula1]

-- peliculasNoAlquiladas :: Pelicula -> String
-- peliculasNoAlquiladas (Pelicula {_id=i,_titulo=t,_alquilada=a}) = case (a) of False -> "Pelicula: "++t 
                                                                              -- True  ->  (peliculas !! (i+1)) peliculasNoAlquiladas (peliculas!! (i+1))
peliculasNoAlquiladas :: Pelicula -> String
peliculasNoAlquiladas (Pelicula {_alquilada=a,_titulo=t,_id=i}) = case a of False -> "Pelicula -> "++ t 
                                                                            True  -> Nothing
...
peliculas_count = length peliculas
